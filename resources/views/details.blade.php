...
@section('content')
    <main class="pt-90">
            ...
            <div class="row">
                ...
                <div class="col-lg-5">
                    <div class="d-flex justify-content-between mb-4 pb-md-2">
                        ...
                        <!--<div
                            ...
                            <a href="#" class="text-uppercase fw-medium"><svg width="10" height="10" viewBox="0 0 25 25" xmlns="http://www.w3.org/2000/svg">
                                ...
                                </svg><span class="menu-link menu-link_us-s">Prec</span></a>
                            <a href="#" class="text-uppercase fw-medium"><span class="menu-link menu-link_us-s">Suiv</span><svg width="10" height="10" viewBox="0 0 25 25" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="product-single__price">
                        <span class="current-price">
                             @if($product->sale_price)
                                <s>{{$product->regular_price}} FCFA</s> {{$product->sale_price}} FCFA {{round(($product->regular_price - $product->sale_price)*100/$product->regular_price)}} % OFF
                            @else
                    ...
                    @if(Cart::instance("cart")->content()->Where('id',$product->id)->count()>0)
                        <a href="{{route('cart.index')}}" class="btn btn-warning mb-3">Aller au Panier</a>
                    @else
                            ...
                            <form method="POST" action="{{route('wishlist.item.remove',['rowId'=>Cart::instance("wishlist")->content()->Where('id',$product->id)->first()->rowId])}}" id="frm.remove.item">
                                ...
                                @method("DELETE")
                                    <a href="javascript:void(0)" class="menu-link menu-link_us-s add-to-wishlist filled-heart" onclick="document.getElementById('frm.remove.item').submit();"><svg width="16" height="16" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <use href="#icon_heart" />
                                        </svg><span>retire des Favoris</span></a>
                            </form>
                        @else
                            <form method="POST" action="{{route('wishlist.add')}}" id="wishlist-form">
                                ...
                                <a href="javascript:void(0)" class="menu-link menu-link_us-s add-to-wishlist" onclick="document.getElementById('wishlist-form').submit();"><svg width="16" height="16" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <use href="#icon_heart" />
                                </svg><span>Ajouter aux Favoris</span></a>
                            </form>
                        @endif
        ...
        <section class="products-carousel container">
            <h2 class="h3 text-uppercase mb-4 pb-xl-2 mb-xl-4">Autres <strong>Produits</strong></h2>
