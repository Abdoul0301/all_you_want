...
@section('content')
    ...
    <main class="pt-90" style="padding-top: 0px;">
        ...
        <section class="my-account container">
            <h2 class="page-title">Détails des commandes</h2>
            <div class="row">
                ...
                <div class="col-lg-10">
                        ...
                        <div class="flex items-center justify-between gap10 flex-wrap">
                            <div class="row">
                                ...
                                <div class="col-6 text-right">
                                    <a class="btn btn-sm btn-danger" href="{{route('user.orders')}}">Retour</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <table class="table table-bordered table-transaction">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @else
                                        <span class="bg-warning">Commandée</span>
                                    @endif
                                </td>
                            </tr>
                        </table>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered">
                                ...
                                <tr>
                                    ...
                                    {{--<th class="text-center">Référence (SKU)</th>--}}
                    ...
                    <div class="wg-box mt-5">
                        <div class="table-responsive">
                            ...
                            <table class="table table-striped table-bordered table-transaction">
                                <tr>
                                    ...
                                    {{--<th>Réduction</th>
                                    <td>{{$transaction->order->discount}} FCFA</td>--}}
                                </tr>
                                <tr>
                                    <th>Total</th>
                        ...
                        @if($order->status == 'commander')
                            <div class="wg-box mt-5 text-right">
                                <form action="{{route('user.order.cancel')}}" method="POST">
                                    @csrf
                                    @method("PUT")
                                    <input type="hidden" name="order_id" value="{{$order->id}}" />
                                    <button type="button" class="btn btn-danger cancel-order">Annuler la commande</button>
                                </form>
                            </div>
                        @endif
                    </div>
