                    ...
                    <div class="cart-table__wrapper">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <form method="POST" action="{{route('wishlist.move.to.cart',['rowId'=>$item->rowId])}}">
                                                    @csrf
                                                    <button type="submit" class="remove-cart btn btn-sm btn-warning">Ajout au Panier</button>
                                                </form>
                                            </div>
                        ...
                        <div class="cart-table-footer">
                            <form method="POST" action="{{route('wishlist.items.clear')}}" >
                                @csrf
                                @method("DELETE")
                                <button class="btn btn-light" type="submit">Retirer les Favoris</button>
                            </form>
                        </div>
                    </div>
                @else
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <a href="{{route('shop.index')}}" class="btn btn-info">Ajouter</a>
                        </div>
                    </div>
                @endif
            </div>
