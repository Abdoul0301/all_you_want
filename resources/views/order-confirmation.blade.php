    ...
    <main class="pt-90">
        ...
        <section class="shop-checkout container">
            ...
            <div class="checkout-steps">
                ...
                <em>Revoyez et soumettez votre commande</em>
            </span>
                </a>
            </div>
                ...
                <div class="checkout__totals-wrapper">
                    <div class="checkout__totals">
                        ...
                        <table class="checkout-totals">
                            ...
                            <tr>
                                <th>SOUS-TOTAL</th>
                                <td class="text-right">{{$order->subtotal}} FCFA</td>
                            </tr>
                            <tr>
                                <th>RÉDUCTION</th>
                                <td class="text-right">{{$order->discount}} FCFA</td>
                            </tr>
                            <tr>
                                <th>LIVRAISON</th>
                                <td class="text-right">Livraison gratuite</td>
                            </tr>
                            <tr>
                                <th>TVA</th>
                                <td class="text-right">{{$order->tax}} FCFA</td>
                            </tr>
                            <tr>
                                <th>TOTAL</th>
