                                    ...
                                    @foreach ($categories as $category)
                                        <li class="list-item d-flex align-items-center justify-content-between">
                                            <span class="d-flex align-items-center">
                                                <input type="checkbox" name="categories" value="{{$category->id}}" class="chk-category me-2"
                            ...
                            <div class="search-field multi-select accordion-body px-0 pb-0">
                                <ul class="list list-inline mb-0 brand-list">
                                    @foreach ($brands as $brand)
                                        <li class="list-item d-flex align-items-center justify-content-between">
                                            <span class="d-flex align-items-center">
                                                <input type="checkbox" name="brands" value="{{$brand->id}}" class="chk-brand me-2"
                ...
                <div class="accordion" id="price-filters">
                    <div class="accordion-item mb-4">
                        ...
                        <div id="accordion-filter-price" class="accordion-collapse collapse show border-0"
                            ...
                            <input class="price-range-slider" type="text" name="price_range" value="" data-slider-min="500"
                                   data-slider-max="50000" data-slider-step="5"
                                   data-slider-value="[{{$min_price}},{{$max_price}}]"
                                   data-currency="*" />
                            <div class="price-range__info d-flex align-items-center mt-2">
                                <div class="me-auto">
                                    <span class="text-secondary">Min Prix: </span>
                                    <span class="price-range__min">{{$min_price}} FCFA</span>
                                </div>
                                <div>
                                    <span class="text-secondary">Max Prix: </span>
                                    <span class="price-range__max">{{$max_price}} FCFA</span>
                                </div>
                            </div>
                        </div>
              ...
              "clickable": true
                                ...
                                <div class="slide-split_text position-relative d-flex align-items-center"
                                    ...
                                    <div class="slideshow-text container p-3 p-xl-5">
                                        <h2
                                            ...
                                            ACCESSOIRES <br /><strong>FEMME</strong></h2>
                                        <p class="mb-0 animate animate_fade animate_btt animate_delay-5" />Les accessoires sont le meilleur moyen de
                                        mettez à jour votre look. Ajoutez une touche de titre avec de nouveaux styles et de nouvelles couleurs, ou optez pour des pièces intemporelles.</h6>
                                    </div>
                                </div>
                                <div class="slide-split_media position-relative">
                                    <div class="slideshow-bg" style="background-color: #f5e6e0;">
                                        <img loading="lazy" src="assets/images/shop/0.jpg" width="630" height="450"
                            ...
                            <div class="slide-split h-100 d-block d-md-flex overflow-hidden">
                                <div class="slide-split_text position-relative d-flex align-items-center"
                                    ...
                                    <div class="slideshow-text container p-3 p-xl-5">
                                        <h2
                                            class="text-uppercase section-title fw-normal mb-3 animate animate_fade animate_btt animate_delay-2">
                                            ACCESSOIRES <br /><strong>HOMME</strong></h2>
                                        <p class="mb-0 animate animate_fade animate_btt animate_delay-5" />Les accessoires sont le meilleur moyen de
                                        mettez à jour votre look. Ajoutez une touche de titre avec de nouveaux styles et de nouvelles couleurs, ou optez pour des pièces intemporelles.</h6>
                                    </div>
                                </div>
                                <div class="slide-split_media position-relative">
                                    <div class="slideshow-bg" style="background-color: #f5e6e0;">
                                        <img loading="lazy" src="assets/images/shop/1.jpg" width="630" height="450"
                                             alt="Women's accessories" class="slideshow-bg__img object-fit-cover" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="slide-split h-100 d-block d-md-flex overflow-hidden">
                                <div class="slide-split_text position-relative d-flex align-items-center"
                                    ...
                                    <div class="slideshow-text container p-3 p-xl-5">
                                        <h2
                                            class="text-uppercase section-title fw-normal mb-3 animate animate_fade animate_btt animate_delay-2">
                                            ACCESSOIRES <br /><strong>ENFANT</strong></h2>
                                        <p class="mb-0 animate animate_fade animate_btt animate_delay-5" />Les accessoires sont le meilleur moyen de
                                        mettez à jour votre look. Ajoutez une touche de titre avec de nouveaux styles et de nouvelles couleurs, ou optez pour des pièces intemporelles.</h6>
                                    </div>
                                </div>
                                <div class="slide-split_media position-relative">
                                    <div class="slideshow-bg" style="background-color: #f5e6e0;">
                                        <img loading="lazy" src="assets/images/shop/2.jpg" width="630" height="450"
                                             alt="Women's accessories" class="slideshow-bg__img object-fit-cover" />
                                    </div>
                                </div>
                            </div>
                ...
                <div class="d-flex justify-content-between mb-4 pb-md-2">
                    ...
                    <div class="shop-acs d-flex align-items-center justify-content-between justify-content-md-end flex-grow-1" >
                        <select class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0" style="margin-right:20px;" aria-label="Page Size" id="pagesize" name="pagesize" style="margin-right:20px";>
                            <option value="12" {{$size=='12'? 'selected':''}}>Voir</option>
                    ...
                    <select class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0" aria-label="Sort Items" id="orderby" name="orderby">
                        <option value="-1" {{$order == -1 ? 'selected':''}}>Par défaut</option>
                        <option value="1" {{$order == 1 ? 'selected':''}}>Date, nouveau à ancien</option>
                        <option value="2"{{$order == 2 ? 'selected':''}}>Date, ancien à nouveau</option>
                        <option value="3" {{$order == 3 ? 'selected':''}}>prix : bas à haut</option>
                        <option value="3" {{$order == 4 ? 'selected':''}}>prix : haut à bas</option>
                    </select>
                      ...
                      <use href="#icon_next_sm" />
                                    ...
                                    @else
                                        <form name="addtocart-form" method="post" action="{{route('cart.add')}}">
                                            ...
                                            <button type="submit" class="pc__atc btn anim_appear-bottom btn position-absolute border-0 text-uppercase fw-medium " data-aside="cartDrawer" title="Ajouter au panier">Ajouter au panier</button>
                                        </form>
                                    @endif
                                </div>
                                    ...
                                    <div class="product-card__price d-flex">
                                        <span class="money price">
                                            @if($product->sale_price)
                                                <s>{{$product->regular_price}} FCFA</s> {{$product->sale_price}} FCFA
                                            @else
