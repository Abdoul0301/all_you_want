            ...
            <div class="wg-box">
                <form class="form-new-product form-style-1" action="{{route('admin.category.store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <fieldset class="name">
                        ...
                        <input class="flex-grow" type="text" placeholder="Nom de la Catégorie" name="name" tabindex="0" value="{{old('name')}}" aria-required="true" required="">
                    </fieldset>
                    @error("name")
                    ...
                    <fieldset class="name">
                        ...
                        <input class="flex-grow" type="text" placeholder="Slug de la Catégorie" name="slug" tabindex="0" value="{{old('slug')}}" aria-required="true" required="">
                    </fieldset>
                    @error("slug")
                    <span class="alert alert-danger text-center">
                            {{$message}}
