    ...
    <div class="main-content-inner">
        <div class="main-content-wrap">
            <div class="flex items-center flex-wrap justify-between gap20 mb-27">
                <h3>Informations sur la Catégorie</h3>
            ...
            <div class="wg-box">
                <form class="form-new-product form-style-1" action="{{route('admin.category.update')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <fieldset class="name">
                        ...
                        <input class="flex-grow" type="text" placeholder="Nom de la Catégorie" name="name" tabindex="0" value="{{$category->name}}" aria-required="true" required="">
                    </fieldset>
                    @error("name")
                    ...
                    <fieldset class="name">
                        ...
                        <input class="flex-grow" type="text" placeholder="Slug de la Catégorie" name="slug" tabindex="0" value="{{$category->slug}}" aria-required="true" required="">
                    </fieldset>
                    @error("slug")
                    <span class="alert alert-danger text-center">
                            {{$message}}
